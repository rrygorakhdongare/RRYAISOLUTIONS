        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            <Link to="/" className="flex items-center mb-6 group">
              ...
              <img
                src={logo}
                alt="RRY AI Solutions Logo"
                className="h-12 w-auto mr-3 rounded-lg object-contain bg-transparent"
              />
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Innovating the future with intelligent software, AI & IoT.  
              We build powerful, scalable solutions that accelerate your digital transformation.
            </p>

            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/company/rry-ai-solutions"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 p-2 rounded-full text-gray-400 hover:text-white hover:bg-primary transition-all"
              >
                <Linkedin className="h-4 w-4" />
              </a>

              <a
                href="https://www.instagram.com/rryaisolutions?utm_source=qr&igsh=MW5wcGo5dnowa2IxZg=="
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 p-2 rounded-full text-gray-400 hover:text-white hover:bg-primary transition-all"
              >
              ...
              <a
                href="https://www.facebook.com/share/1BpqAQ9uaR/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 p-2 rounded-full text-gray-400 hover:text-white hover:bg-primary transition-all"
              >
